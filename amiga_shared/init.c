...
/* Version Tag */
#include "fribidi.library_rev.h"
STATIC CONST UBYTE USED verstag[] = VERSTAG;

struct FriBidiLibrary
{
...
{
    struct FriBidiLibrary *libBase = (struct FriBidiLibrary *)Self->Data.LibBase; 
...
STATIC struct Library *libInit(struct Library *LibraryBase, APTR seglist, struct Interface *exec)
{
    ...
    struct FriBidiLibrary *libBase = (struct FriBidiLibrary *)LibraryBase;
    ...
    libBase->libNode.lib_Node.ln_Name = "fribidi.library";
...
{
	{ CLT_DataSize,		sizeof(struct FriBidiLibrary)	},
